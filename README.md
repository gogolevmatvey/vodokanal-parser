...
---
> **Примечание о данных:** Проект предназначен для работы с вымышленными данными. Файл `Сгенерированные данные.txt` создан программным путем и не содержит реальной персональной информации пользователей.
