...
public class ConfigManager {
    ...
    // ====================================
    // Методы для доступа к настройкам обработки (ETL)
    // ====================================

    public int getEtlBatchSize() {
        return getInt("etl.batch.size", 500);
    }

    public int getEtlProgressInterval() {
        return getInt("etl.progress.interval", 1000);
    }
}
